                    ...
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                <h4>{{$user->batch1}}</h4>
                                <a href="/attendance/{{$user->batch1}}/create" class="btn btn-default">Upload Attendance</a>
                            </div>
                        </div>
                    </div>
                </section>
                <section class="contact-area">
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                <h4>{{$user->batch2}}</h4>
                                <a href="/attendance/{{$user->batch2}}/create" class="btn btn-default">Upload Attendance</a>
                            </div>
                        </div>
                    </div>
                </section>        
